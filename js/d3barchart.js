    ...
    g.selectAll(".bar")
      ...
      .enter().append("rect")
        ...
        .attr("fill",function(d,i){
          ...
          $("#infoDiv p").text('Department: '+d.x+' has base salary: '+d.y+' of city: '+d.z);
...
return "#4A148C";
          ...
          $("#infoDiv p").text('Position: '+d.z+' has salary: '+d.y+' of department: '+d.x);
          console.log('Position: '+d.z+' has salary: '+d.y+' of department: '+d.x);
        }).on("mouseout", function(){
          $("#infoDiv p").text('');
        });
    ...
    g.selectAll(".bar")
      ...
      .enter().append("rect")
        ...
        .attr("fill",function(d,i){
          ...
          $("#infoDiv p").text('Position: '+d.x+' has overtime: '+d.y+' of department: '+d.z);
          console.log('Position: '+d.z+' has salary: '+d.y+' of department: '+d.x);
        }).on("mouseout", function(){
          $("#infoDiv p").text('');
        });
